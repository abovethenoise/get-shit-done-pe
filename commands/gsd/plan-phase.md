...
- `--prd <file>` — Use a PRD/acceptance criteria file instead of discuss-capability. Parses requirements into CONTEXT.md automatically. Skips context discussion entirely.
