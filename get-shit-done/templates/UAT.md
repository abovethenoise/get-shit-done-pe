...
Template for `.planning/capabilities/{cap}/features/{feat}/UAT.md` — persistent UAT session tracking.
...
<!-- YAML format for plan --gaps consumption -->
...
- `feature`: IMMUTABLE - set on creation
...
- This section feeds directly into the plan workflow --gaps
...
5. status → "diagnosed"
6. Ready for plan workflow --gaps with root causes
...
**Resume after /clear:**
1. Read frontmatter → know feature and status
