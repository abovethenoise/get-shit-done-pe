...
| **Contains** | System architecture and component connections; business domain vocabulary (e.g., poker: "hand," "pot odds," "position"; football: "touchdown," "down," "red zone") and where those concepts manifest in code; architectural decisions (ADRs); voice/tone/design direction |
...
Decisions do not have a dedicated directory. They route by type:
...
Domain concept mapping does not have a dedicated file. It lives in `.docs/domain-vocabulary.md` (Tier 3) — the vocabulary doc defines business concepts the project deals with (e.g., what a "hand" or "pot odds" means in a poker app) and where those concepts manifest in code.
